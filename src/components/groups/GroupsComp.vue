  ...
  methods: {
    ...
    deleteGroup(group) {
      Dialog.create({
        ...
        console.log(group);
        // if (group.id) this.loaders.deleteBtn[id] = true;
        // this.loaders.delete = true;
        this.$axios
          .post("deletegroup", {
            group_id: group.id,
            delete_by_user_id: store.userdetails.id,
          })
          .then((response) => {
            // this.loaders.delete = false;
            // if (group.id) this.loaders.deleteBtn[id] = false;
            this.refreshPage();
          })
          .catch((response) => {
            console.log(response);
